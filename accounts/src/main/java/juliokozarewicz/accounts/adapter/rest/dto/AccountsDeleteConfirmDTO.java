...
import juliokozarewicz.accounts.application.command.AccountsDeleteConfirmCommand;

public record AccountsDeleteConfirmDTO(
...
) implements AccountsDeleteConfirmCommand {
