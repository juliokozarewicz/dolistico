...
@Component
public class AccountsLoginRequestProducer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AccountsLoginRequestProducer.class);
    private final KafkaTemplate<String, byte[]> kafkaTemplate;
    private final ObjectMapper objectMapper;
    private final MessageSource messageSource;

    public AccountsLoginRequestProducer(
    ...
    public void execute(
        ...
        try {
            ...
            ClassPathResource templateResource = new ClassPathResource(
                "templates/email/AccountsLoginRequest.html"
            );
            ...
            message = message
                ...
                .replace(
                    "{{email_account_request_login_message}}",
                    messageSource.getMessage("email_account_request_login_message", null, locale)
                )
            ...
            AccountsSendEmailCommand emailMessageMap = new AccountsSendEmailCommand(
                email,
                messageSource.getMessage("email_account_request_login_subject", null, locale),
                message.toString()
            );
