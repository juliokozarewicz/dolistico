...
@Component
public class AccountsDeleteRequestProducer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AccountsDeleteRequestProducer.class);
    private final KafkaTemplate<String, byte[]> kafkaTemplate;
    private final ObjectMapper objectMapper;
    private final MessageSource messageSource;

    public AccountsDeleteRequestProducer(
    ...
    public void execute(
        ...
        try {
            ...
            ClassPathResource templateResource = new ClassPathResource(
                "templates/email/AccountsDeleteRequest.html"
            );
            ...
            message = message
                ...
                .replace(
                    "{{email_account_delete_request_message}}",
                    messageSource.getMessage("email_account_delete_request_message", null, locale)
                )
            ...
            AccountsSendEmailCommand emailMessageMap = new AccountsSendEmailCommand(
                email,
                messageSource.getMessage("email_account_delete_subject", null, locale),
                message.toString()
            );
