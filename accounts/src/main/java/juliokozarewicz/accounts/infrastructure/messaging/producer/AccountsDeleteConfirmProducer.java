...
@Component
public class AccountsDeleteConfirmProducer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AccountsDeleteConfirmProducer.class);
    private final KafkaTemplate<String, byte[]> kafkaTemplate;
    private final ObjectMapper objectMapper;
    private final MessageSource messageSource;

    public AccountsDeleteConfirmProducer(
    ...
    public void execute(
        ...
        try {
            ...
            ClassPathResource templateResource = new ClassPathResource(
                    "templates/email/AccountsDeleteConfirm.html"
            );
            ...
            message = message
                ...
                .replace(
                        "{{email_account_delete_confirm_message}}",
                        messageSource.getMessage("email_account_delete_confirm_message", null, locale)
                )
