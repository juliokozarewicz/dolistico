...
public enum GlobalExceptionEnum {
    ...
    ACCOUNTS_INVALID_PIN(400, "ACCOUNTS_INVALID_PIN", DomainExceptionEnum.ACCOUNTS_INVALID_PIN),
    ...
    public static final String ACCOUNTS_INVALID_PAGE_NUMBER = "ACCOUNTS_INVALID_PAGE_NUMBER";
