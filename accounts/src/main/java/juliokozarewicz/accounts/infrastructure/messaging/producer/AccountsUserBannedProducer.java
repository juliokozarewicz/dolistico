...
@Component
public class AccountsUserBannedProducer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AccountsUserBannedProducer.class);
    private final KafkaTemplate<String, byte[]> kafkaTemplate;
    private final ObjectMapper objectMapper;
    private final MessageSource messageSource;

    public AccountsUserBannedProducer(
    ...
    public void execute(
        ...
        try {
            ...
            message = message
                    ...
                    .replace(
                            "{{email_account_banned_message}}",
                            messageSource.getMessage("email_account_banned_message", null, locale)
                    )
            ...
            AccountsSendEmailCommand emailMessageMap = new AccountsSendEmailCommand(
                email,
                messageSource.getMessage("email_account_deactivated_subject", null, locale),
                message.toString()
            );
